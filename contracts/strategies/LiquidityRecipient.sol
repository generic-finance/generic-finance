...
contract LiquidityRecipient is Controllable {
  ...
  // The treasury to provide GNRC, and to receive GNRC or overdraft weth
  ...
  * and providing approvals to the strategy (for WETH) and to treasury (for GNRC). The strategy
  ...
  */
  ...
  /**
  * If Uniswap returns less GNRC and more WETH, the WETH excess will be present in this strategy.
